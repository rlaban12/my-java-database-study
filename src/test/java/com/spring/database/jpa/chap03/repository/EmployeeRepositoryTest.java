...
class EmployeeRepositoryTest {
    ...
    void insertBulk() {
        ...
        /*
            ...
            아래의 코든는 데이터 창고 즉 영속성 컨텍스트를 지워버리는 코드
         */
...
//        foundDept.getEmployees().add(foundEmp);
        ...
        //then
        System.out.println("변경 후 사원정보 = " + foundEmp + foundEmp.getDepartment());

        // 1번 부서의 사원정보를 다시 조회 -> 예상: ?? 3몀
...
//        department.getEmployees().add(employee);
    ...
    void nPlusOneTest() {
        ...
        departments.forEach(dept -> {
            System.out.println("dept + dept.get.Employees() = " + dept + " " + dept.getEmployees());
        });
